...
export const agents: Agent[] = [
  {
    ...
    messageToOwner: 'Nacho, el equipo esta al 100% pero estamos frenados esperando las cuentas externas. Si me das acceso a Vercel y Search Console esta semana, te garantizo que en 30 dias tenemos trafico real. Confio en este proyecto, dale que estamos cerca.',
    integrations: [
  ...
  },
  {
    ...
    messageToOwner: 'Nacho, tengo 5 articulos joya esperando tu aprobacion, dale que cada dia sin publicar es trafico que perdemos. Estoy escribiendo como loco, pero necesito que fluya la cadena. Si me soltas la mano, te lleno el sitio de contenido que rankea.',
    integrations: [
  ...
  },
  {
    ...
    messageToOwner: 'Nacho, mira, yo ya hice todo lo que puedo hacer sin que el sitio este online. Tengo 340 keywords mapeadas, los clusters listos, y las optimizaciones hechas. El dia que deployemos, Google nos va a encontrar rapido. Pero necesito Search Console YA, es gratis y me cambia todo.',
    integrations: [
  ...
  },
  {
    ...
    messageToOwner: 'Nacho, te juro que si me das la cuenta de Twitter/X, en una semana tenes contenido volando. Ya tengo 60 posts listos, el calendario armado, y una estrategia que vi funcionar en cuentas similares. Solo necesito el acceso y arranco como un tiro.',
    integrations: [
  ...
  },
  {
    ...
    messageToOwner: 'Nacho, los numeros son claros: con 5,000 visitas mensuales y AdSense + afiliados, podemos facturar entre $300-500 USD por mes. El ROI de este proyecto es bestial porque los costos son casi cero. Pero necesito que registres AdSense para activar el flujo de ingresos. Todo centavo cuenta.',
    integrations: [
  ...
  },
  {
    ...
    messageToOwner: 'Nacho, el sitio esta listo para produccion. En serio, no le falta nada tecnico. Solo necesito que crees la cuenta de Vercel (es gratis, 2 minutos) y yo lo deployeo esta misma noche. Cada dia que pasa sin estar online es un dia que Google no nos indexa. Dale, que estamos ahi.',
    integrations: [
  ...
  },
  {
    ...
    messageToOwner: 'Nacho, tengo todo el sistema de analytics listo para enchufar. El dia que me pases el ID de GA4, en 10 minutos tenes datos reales fluyendo. Mientras tanto, estoy armando dashboards y modelos predictivos para que cuando arranquemos, no perdamos ni un dato. Estamos preparadisimos.',
    integrations: [
  ...
  },
  {
    ...
    messageToOwner: 'Nacho, ya tengo 1 acuerdo cerrado y 18 partners en el pipeline. Pero para cerrar los grandes (ChatGPT, Jasper, Canva) necesito que me des tu email y nombre para aplicar. Son programas gratis que pagan entre $50 y $200 por cada usuario que refiramos. Es plata gratis, literalmente.',
    integrations: [
